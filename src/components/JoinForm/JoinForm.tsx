export default function JoinForm() {
  return (
    <section
      id="joinFormSection"
      className="py-6 bg-red-500 text-white cursor-default"
    >
        ...
        <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
          <label className="block">
            ...
            <input
              ...
              className="block w-full h-8 pl-2 rounded-md shadow-sm focus:ring"
            />
          </label>
          <label className="block">
          ...
          <label className="block">
            ...
            <textarea className="block w-full rounded-md focus:ring"></textarea>
          </label>
          <button
            type="button"
